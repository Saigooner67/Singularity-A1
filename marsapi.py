...
# NASA InSight API (DEMO_KEY works, but you can use your own key)
...
def index():
    try:
        ...
        # Build dictionary to send to HTML
        mars_weather = {
            "sol": latest_sol,
    ...
    # This passes the data to the HTML template
    return render_template("index.html", weather=mars_weather)

if __name__ == "__main__":
    # debug=True reloads automatically on save
